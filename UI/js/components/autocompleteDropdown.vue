<template>
    <div :class="dropdownClass" style="width: 100%;">
        <div class="input-group" style="width: 100%;">
            <input ref="searchInput" type="text" class="form-control" :placeholder="placeholder"
            @blur="testBlur" @focus="openDropdown" @keydown.stop="keyDownMonitor" @keyup="keyUpMonitor" v-model=searchText>
            <span @mousedown="clearSearch" v-show="(!isIE || !isActive) && searchText.length > 0" class="glyphicon glyphicon-remove"
